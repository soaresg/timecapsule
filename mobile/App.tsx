    ...
    >
      ...
      <View className='flex-1 items-center justify-center gap-6'>
        ...
        <View className='space-y-2'>
          ...
          <Text className='text-center font-body text-base leading-relaxed text-gray-100'>Colecione momentos marcantes da sua hornada e compartilhe (se quiser) com o mundo!</Text>
        </View>
